...
const addCrew = () => {
  props.form.data.mission.spacecraft.crew.push({
    name: '',
    role: ''
  })
}
...
const deleteCrew = () => {
  const index = props.form.data.mission.spacecraft.crew.indexOf()
  props.form.value.data.mission.spacecraft.crew.splice(index, 1)
}
